  <div class="hidden sm:hidden lg:block xl:block md:hidden crew__background">
    ...
    <div class="text-center sm:text-left sm:flex-grow">
      <div class="mb-4 ">
        ...
        <p class="leading-tight text-c-darkgrey py-2">Connect with Jakob on facebbok to follow the trip as it progresses</p>
      </div>
      <div>
        <button class=" font-semibold rounded-full px-4 py-1 leading-normal bg-white border border-c-blue text-c-blue hover:bg-c-blue hover:text-white">Connect with Jacob</button>
      </div>
    </div>
  </div>
  <script>
